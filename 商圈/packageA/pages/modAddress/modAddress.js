// pages/modAddress/modAddress.js
const app = getApp()
Page({
  ...
  getAddressInfo(id) {
    let thet = this;
    wx.request({
      url: app.globalData.myhost + '/goods/consignee/getAddressInfo',
      data: {
        addressId: id
      },
      header: {
      ...
      success: function(res) {
        ...
        let province = res.data.result.provinceName + '-' + res.data.result.cityName
        let value = ''
        ...
        thet.setData({
          ...
          value: value,
          name: res.data.result.consigneeName,
          telephone: res.data.result.consigneePhone,
          address: res.data.result.consigneeDetail
        })
      },
      fail: function(res) {},
  ...
  updAddress(data) {
    ...
    wx.request({
      url: app.globalData.myhost+ '/goods/consignee/updAddress',
      data: {
        id: then.data.id,
