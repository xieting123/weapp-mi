...
Page({
  ...
  //我的指定店铺订单分页列表(必传token, storeId为店铺id, orderStatus不传  查所有订单, 传指定状态, 查询指定状态的订单): http://192.168.101.10:4000/goods/productOrder/storeOrders?createTime=&pageSize=&pageNum&storeId
  myOrderslist() {
    var that = this;
    wx.request({
      url: app.globalData.myhost + '/goods/productOrder/storeOrders',
      data: {
