// packageA/pages/myReward/myReward.js
import {
...
//打赏我的打赏列表(必传token):http://192.168.101.10:4000/user/reward/toMyRewardQuery?createTime=&pageNum=&pageSize=

  rewardlist() {
    var that = this;
    wx.request({
      url: app.globalData.myhost + '/user/reward/toMyRewardQuery',
      method: 'GET',
      data: {
        pageSize: 10,
      ...
      success(res) {
        ...
        that.setData({
          ...
          rewardtotalPage: res.data.result.pagination.totalPage
        })
      }
    })
  },
  ...
  onReachBottom: function () {
    ...
    var totalpage = this.data.rewardtotalPage + 1;
    p++;
    if (p > totalpage) {
      return;
    }
